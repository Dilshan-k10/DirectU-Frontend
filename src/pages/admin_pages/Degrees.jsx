  ...
  const [degrees, setDegrees] = useState([
    {
      ...
      alMath: "C",
      olEnglish: "S",
      requirements: "Required: A/L Pass, A/L Math (C pass), O/L English (S pass)",
      isActive: true, 
    },
    {
      id: 2,
      ...
      alMath: "S",
      olEnglish: "C",
      requirements: "Required: A/L Pass, A/L Math (S pass), O/L English (C pass)",
      isActive: true, 
    },
  ]);
    ...
    <div className="max-w-7xl mx-auto relative">
      ...
      <div className="bg-brand-light rounded-2xl shadow-sm p-8">
        ...
        <div className="flex justify-between items-center pb-5 mb-6 border-b border-gray-200">
          <h2 className="text-gray-700 font-semibold text-lg">Degree Programs</h2>
          <button 
              ...
              >
                <div className="flex-grow">
                  <h3 className={`text-xl font-bold mb-1.5 transition flex items-center gap-2 ${deg.isActive ? 'text-white' : 'text-gray-400'}`}>
                    {deg.name} 
                    <span className="text-xs font-normal px-2 py-1 bg-white/10 rounded-md text-gray-300">{deg.type} | {deg.duration}</span>
                  </h3>
