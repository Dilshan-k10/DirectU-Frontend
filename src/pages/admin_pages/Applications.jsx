...
const Applications = () => {
  ...
  const handleViewApplicants = () => {
    ...
    const result = allApplications.filter(
      (app) =>
        app.intakeId === selectedIntake && app.programId === selectedDegree,
    );
    setFiltered(result);
    setSearched(true);
    setLoading(false);
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {filtered.map((app, index) => (
                    ...
                    >
                      <td className="py-3 pr-6 text-white/40 font-medium whitespace-nowrap">
                        {index + 1}
                      </td>
                      ...
                      <td className="py-3">
                        <button
                          ...
                          className="flex items-center gap-1.5 bg-[#1e3a8a] hover:bg-[#1d4ed8] text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition"
                        >
