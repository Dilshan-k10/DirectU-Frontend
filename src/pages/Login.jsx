...
const Login = () => {
  ...
  const inputClass = (field) =>
    `w-full bg-slate-50 dark:bg-brand-dark border rounded-lg py-3.5 pl-12 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:ring-2 outline-none transition-all ${
      errors[field]
        ? 'border-red-400 focus:ring-red-400/30'
        : 'border-slate-200 dark:border-primary/30 focus:ring-primary/50 focus:border-primary/50'
    }`;
