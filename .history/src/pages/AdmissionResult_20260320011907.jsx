              ...
              <div className="flex items-start space-x-4 mt-10 max-w-md">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">
                    Suggested Alternative Programmes
                  </h3>
                  <p className="text-gray-300 text-sm leading-relaxed">
                    According to your CV, this is the most suitable program to
                    follow for your future. Are you ready to take the risk?
                  </p>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-xs">
                      {alternativeProgram?.level
                        ? String(alternativeProgram.level)
                        : " "}
                    </p>
                  </div>
                </div>
                  ...
                  {showBreakdown && analysisBreakdown.length > 0 && (
                    <div className="mt-6 bg-gray-50 rounded-2xl border border-gray-100 p-5">
                      <div className="flex items-center gap-2 text-sm font-bold text-blue-900 mb-4">
                        <span className="inline-flex w-7 h-7 rounded-lg bg-accent/10 items-center justify-center text-accent">
                          ✦
                        </span>
                        Analysis Breakdown
                      </div>
