          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none bg-[#111827] text-white/80 text-sm px-4 py-3 pr-10 rounded-xl border border-white/5 focus:outline-none focus:border-white/20 transition cursor-pointer"
              >
                {degrees.map((degree) => (
                  <option
                    key={degree.id}
