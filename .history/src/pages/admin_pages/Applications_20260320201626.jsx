      ...
      <div className="bg-brand-light rounded-2xl mb-6 overflow-hidden">
        <div className="flex flex-col sm:flex-row items-end gap-4 px-8 py-6 border-t border-white/10">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#1e3a8a] hover:bg-[#1d4ed8] text-white text-xs font-bold px-6 py-3 rounded-xl transition whitespace-nowrap tracking-[0.1em]"
          >
