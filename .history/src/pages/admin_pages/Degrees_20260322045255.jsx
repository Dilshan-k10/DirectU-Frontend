      ...
      <div className="bg-brand-light rounded-2xl shadow-sm p-8">
        ...
        <div className="flex justify-between items-center pb-5 mb-6 border-b border-gray-200">
          ...
          <button 
            ...
            className="bg-primary hover:bg-brand text-white flex items-center gap-2 px-5 py-2.5 rounded-xl transition font-semibold text-sm shadow-md shadow-[#6366f1]/20"
          >
