  ...
  return (
    <div>
      ...
      <div className="flex col-2 gap-6">
        <div className="mt-10 bg-brand-light rounded-2xl p-8">
          {/* chart base on total Apllication and Qualified Applications percentage */}
        </div>
        <div className="mt-10 bg-brand-light rounded-2xl p-8"></div>
      </div>
    </div>
  );
};
