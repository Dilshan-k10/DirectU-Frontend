      ...
      <div className="p-8 bg-brand-light rounded-2xl mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-end gap-4  border-t border-white/10">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-[#0d1228] text-white text-sm px-4 py-3 pr-10 rounded-xl border border-white/10 focus:outline-none focus:border-white/30 transition cursor-pointer"
              >
                {intakes.map((intake) => (
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none bg-[#0d1228] text-white text-sm px-4 py-3 pr-10 rounded-xl border border-white/10 focus:outline-none focus:border-white/30 transition cursor-pointer"
              >
                {degrees.map((degree) => (
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#1e3a8a] hover:bg-[#1d4ed8] text-white text-sm font-semibold px-6 py-3 rounded-xl transition whitespace-nowrap"
          >
