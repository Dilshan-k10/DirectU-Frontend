  ...
  return (
    <div>
      ...
      <div className="mt-6 bg-brand-light rounded-2xl p-8">
        <h2 className="text-gray-700 font-semibold text-base mb-1">Applications by Programme</h2>
        <p className="text-gray-400 text-xs mb-6">Number of applications submitted per degree programme</p>
        <ResponsiveContainer width="100%" height={260}>
          <LineChart data={applicationsByProgram}>
            ...
            <Line
              ...
              stroke="#6366f1"
              strokeWidth={2.5}
              dot={{ fill: "#6366f1", r: 1, strokeWidth: 2, stroke: "#1a1f36" }}
