          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="relative">
              <select
                ...
                className="w-full appearance-none bg-[#111827] text-white/80 text-sm px-4 py-3 pr-10 rounded-2lg border border-white/5 focus:outline-none focus:border-white/20 transition cursor-pointer"
              >
                {intakes.map((intake) => (
                  <option
                    key={intake.id}
                ...
                <tbody>
                  {filtered.map((app) => (
                    ...
                    >
                      ...
                      <td className="py-3 pr-6 text-white/50 whitespace-nowrap max-w-[160px] truncate">
                        {app.documentName}
                      </td>
