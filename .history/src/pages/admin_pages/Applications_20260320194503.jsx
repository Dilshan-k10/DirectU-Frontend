      ...
      <div className="p-8 bg-brand-light rounded-2xl mb-10">
        ...
        <div className="flex flex-col sm:flex-row items-end gap-4  border-t border-white/10">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-primary hover:bg-primary-hover text-white text-sm font-semibold px-6 py-3 rounded-xl transition whitespace-nowrap"
          >
