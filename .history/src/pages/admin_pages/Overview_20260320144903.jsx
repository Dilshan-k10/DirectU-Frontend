      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-4">
        {CARDS.map((card) => (
          <StatCard
            ...
            loading={
              (card.label === "Total Applications" || card.label === "Total Active Degrees" || card.label === "Total Applicants" || card.label === "Active Intake" || card.label === "Qualified Applications" || card.label === "Not Qualified Applications") && loading
            }
          />
        ))}
      </div>
