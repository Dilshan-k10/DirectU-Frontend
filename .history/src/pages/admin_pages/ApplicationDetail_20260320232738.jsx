  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <span
          className={`ml-auto px-3 py-1.5 rounded-full text-xs font-semibold capitalize ${STATUS_STYLES[app.status] || "bg-white/10 text-white/50"}`}
        >
        ...
        <div className="bg-brand-card rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <Field
              ...
              value={
                <span
                  className={`ml-auto px-3 py-1.5 rounded-full text-xs font-semibold capitalize ${STATUS_STYLES[app.status] || "bg-white/10 text-white/50 mt-10 inline-block"}`}
                >
                  {app.status.replace("_", " ")}
                </span>
              }
