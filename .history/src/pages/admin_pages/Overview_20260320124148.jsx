...
const StatCard = ({ label, value, loading }) => {
  return (
    <div className="bg-[#1a1f36] rounded-2xl p-5 flex flex-col justify-between gap-6 min-w-0">
      ...
      {loading ? (
        ...
        <p className="text-white text-6xl font-bold tracking-tight item-center">{value}</p>
      )}
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {CARDS.map((card) => (
          <StatCard
            ...
            loading={card.label === "Total Applications" && loading}
          />
        ))}
      </div>
    </div>
