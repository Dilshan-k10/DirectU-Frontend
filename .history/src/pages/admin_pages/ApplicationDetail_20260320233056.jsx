    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-brand-card rounded-2xl p-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <Field label="Current Status" value={<span className={`ml-auto px-3 py-1.5 rounded-full text-xs font-semibold capitalize [app.status] || 'bg-white/10 text-white/50'}`}>
              {app.status.replace('_', ' ')}
            </span>} />
          </div>
        </div>
