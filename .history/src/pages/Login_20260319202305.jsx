          ...
          <div className="p-8 sm:p-12">
            ...
            <div className="flex flex-col items-center mb-10">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-sm text-center">
                Enter your credentials to access DirectU
              </p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-brand-dark border border-slate-200 dark:border-primary/30 rounded-lg py-3.5 pl-12 pr-4 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:ring-2 focus:ring-primary/50 focus:border-primary/50 outline-none transition-all"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <a
                    href="#"
                    className="text-accent hover:text-accent-hover text-xs font-semibold transition-colors hidden"
                  >
                    Forgot Password?
                  </a>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 dark:bg-brand-dark border border-slate-200 dark:border-primary/30 rounded-lg py-3.5 pl-12 pr-12 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:ring-2 focus:ring-primary/50 focus:border-primary/50 outline-none transition-all"
                  />
                  <button
                    type="button"
