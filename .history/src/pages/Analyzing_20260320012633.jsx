...
const Analyzing = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-[#f0f2f8] flex flex-col items-center justify-center p-6 font-sans">
      <style>{`
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="flex justify-between items-center mb-1">
          <h1 className="text-xl font-bold text-gray-800">Application Analysis</h1>
          <span className="text-sm font-semibold text-[#3b4fd8]">Step 2 of 3</span>
        </div>

        {/* Progress bar */}
        <div className="w-full bg-gray-200 rounded-full h-1.5 mb-1">
          <div
            className="bg-[#3b4fd8] h-1.5 rounded-full transition-all duration-300"
        ...
        <div className="flex justify-between text-xs text-gray-400 mb-6">
          ...
          <span className="text-[#3b4fd8] font-semibold">Processing Analysis</span>
        ...
        <div className="bg-white rounded-2xl shadow-sm p-10 flex flex-col items-center text-center mb-4">
          ...
          <p className="text-gray-500 text-sm mb-6 max-w-sm">
            Our AI is currently reviewing your academic records and evaluating eligibility criteria.
          </p>

          {/* Animated step */}
          <div className="bg-gray-50 border border-gray-100 rounded-xl px-6 py-4 w-full max-w-sm">
            <p key={stepIndex} className="fade-step text-sm font-medium text-gray-700 flex items-center gap-2 justify-center">
              <span className="w-2 h-2 rounded-full bg-[#3b4fd8] inline-block flex-shrink-0" />
              {STEPS[stepIndex]}
            </p>
            <p className="text-xs text-[#3b4fd8] mt-1">Estimated time remaining: ~15 seconds</p>
          </div>
        </div>
