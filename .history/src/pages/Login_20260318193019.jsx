          ...
          <div className="p-8 sm:p-12">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-accent to-accent-hover hover:opacity-90 text-white font-bold py-4 rounded-lg shadow-lg shadow-accent/20 transition-all active:scale-[0.98] mt-2 mb-4 disabled:opacity-60 disabled:cursor-not-allowed"
              >
