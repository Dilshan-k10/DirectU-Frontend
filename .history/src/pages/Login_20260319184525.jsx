          ...
          <div className="p-8 sm:p-12">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#0A1035] to-[#EAEAEA] hover:from-[#0A1035] hover:to-[#1A2255] border border-[#1A2255] text-[#EAEAEA] font-bold py-4 rounded-lg shadow-lg shadow-[#03061A]/60 transition-all active:scale-[0.98] mt-2 mb-8 disabled:opacity-60 disabled:cursor-not-allowed"
              >
