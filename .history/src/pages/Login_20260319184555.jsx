            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <a href="#" className="text-accent hover:text-accent-hover text-xs font-semibold transition-colors hidden">
                    Forgot Password?
                  </a>
                </div>
                <div className="relative">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gradient-to-r from-[#0A1035] to-[#0A1035] hover:from-[#0A1035] hover:to-[#1A2255] border border-[#1A2255] text-[#EAEAEA] font-bold py-4 rounded-lg shadow-lg shadow-[#03061A]/60 transition-all active:scale-[0.98] mt-2 mb-8 disabled:opacity-60 disabled:cursor-not-allowed"
              >
