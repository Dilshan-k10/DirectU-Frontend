...
const Sidebar = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      <aside
        className={`
          fixed top-0 left-0 z-30 h-full w-64 bg-[#0A1035] flex flex-col shrink-0
      ...
      >
        {/* Logo */}
        <div className="flex items-center justify-content px-5 py-6 border-b border-white/10">
